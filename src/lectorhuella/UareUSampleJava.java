...
//		add(Box.createVerticalStrut(vgap));
		...
		JButton btnEnrollment = new JButton("Registrar la huella");
...
//		add(Box.createVerticalStrut(vgap));
  ...
  private void selectReaderByDefaul() {
    try {
...
//				Enrollment.Run(m_reader);
	...
	private static void createAndShowGUI() {
      ...
      paneContent.selectReaderByDefaul();
		}
